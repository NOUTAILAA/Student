...
public class Student {
   ...
   @GeneratedValue(strategy = GenerationType.IDENTITY)
    ...
    @JsonIgnore // Ignorer la sérialisation directe de cette propriété
    private Classe classe;

    @Transient // Ignorer la persistance de cette propriété dans la base de données
    private Integer classNom;
...
public Student(int id, String nom, String email, String cin, String mdp, Classe classe) {
	super();
	this.id = id;
	this.nom = nom;
	this.email = email;
