...
const GradeManagement = () => {
  ...
  const fetchStudents = async () => {
    try {
      ...
      console.log('Students:', response.data); // Vérifiez les données des étudiants dans la console
  ...
  const fetchCourses = async () => {
    try {
      ...
      console.log('Courses:', response.data); // Vérifiez les données des cours dans la console
